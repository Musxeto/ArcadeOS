...
mov bl, 0x04   ; Text color: black (lower 4 bits), Background color: white (higher 4 bits)
...
new_line db 10, 13
no_file dw 0
file_list dw FILES_ADDR, FILES_ADDR + OFFSET, FILES_ADDR + 2 * OFFSET, FILES_ADDR + 3 * OFFSET, FILES_ADDR + 4 * OFFSET,FILES_ADDR + 5 * OFFSET,FILES_ADDR + 6 * OFFSET, no_file
